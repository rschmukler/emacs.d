...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (git-gutter-fringe git-gutter nlinum helm-ag flycheck-mix atom-one-dark-theme swiper projectile neotree ivy helm-core helm font-lock+ flycheck elixir-mode counsel-projectile counsel company all-the-icons alchemist doom-themes evil))))
(custom-set-faces
